      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            width: 235.0,
            height: 235.0,
            child: Image.asset('assets/load_screens/5.png'), // Replace with your first image asset path
          ),
          ...
          Positioned(
            ...
            width: 78.0,
            height: 18.0,
            child: Image.asset('assets/load_screens/10.png'), // Replace with your second image asset path
          ),

          // Positioned first text widget
          const Positioned(
            top: 464.0, // Adjust the top position as needed
            left: 119.0, // Adjust the left position as needed
            width: 152.0, // Set the width
